...
for i=1:500
    if (SimulationsTachikawa3DS3(i,1) ~= 78) 
        j=j+1;
        dataT(2,j)=SimulationsTachikawa3DS3(i,1);
        dataT(1,j)=SimulationsTachikawa3DS3(i,2);
    end
end
...
for i=1:500
    if (SimulationsRichardsS3(i,1) ~= 78) 
        j=j+1;
        dataR(2,j)=SimulationsRichardsS3(i,1);
        dataR(1,j)=SimulationsRichardsS3(i,2);
    end
end
...
xi = linspace(0,18,25);
yi = linspace(-6.5,6.5,25)
%hst = hist3(dataT',{xi yi},'Nbins',[20 20] );
hst = hist3(dataT', {yi xi} );
